...
Mirror酱在中国大陆和境外拥有 6000+ 高质量阿里云/腾讯云 CDN 节点，连通性极其优秀，推荐即使未填写 CDK 时也使用 Mirror酱 API 检查，以更高效获取更新消息。
...
Mirror酱 提供不精确的日活统计功能，辅助开发者了解检查更新量、下载量等数据。根据 IP 去重。可在统计面板中查看。
...
自动化上传、Token 配置等常见问题，请参考 [常见问题](./FAQ.md)
